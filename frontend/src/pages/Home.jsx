...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <header className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-lg border-b border-emerald-500/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white tracking-wide">KONTE</h1>
              <p className="text-xs text-emerald-400 tracking-widest">SOLUTIONS</p>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <a href="#servicios" className="text-slate-300 hover:text-emerald-400 transition-colors text-sm">Servicios</a>
            <a href="#plantillas" className="text-slate-300 hover:text-emerald-400 transition-colors text-sm">Plantillas</a>
            <a href="#contacto" className="text-slate-300 hover:text-emerald-400 transition-colors text-sm">Contacto</a>
          </nav>
        </div>
      </header>
      ...
      <section id="contacto" className="py-20 px-6 bg-slate-900/30">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12 space-y-4">
            <h2 className="text-4xl font-bold text-white">Hablemos de tu proyecto</h2>
            <p className="text-slate-400">Respondo en menos de 24h</p>
          </div>
